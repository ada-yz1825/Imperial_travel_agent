...
export TOGETHER_MODEL=MiniMaxAI/MiniMax-M3
export TOGETHER_CHAT_MODELS_JSON='[{"id":"minimaxm3","label":"MiniMax M3","model":"MiniMaxAI/MiniMax-M3","description":"Current default model"},{"id":"glm52","label":"GLM-5.2","model":"zai-org/GLM-5.2","description":"Higher-capability model"}]'
