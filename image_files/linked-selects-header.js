...
/* global bulkUpdate, _ */
var linkedSelectsHeader;

linkedSelectsHeader = (function () {

    var linkedSelectsHeaderJSON,
        defaultConfig = {
            'isSearch': false
        },
        $selects,
    ...
    function init(json, config) {
        ...
        $selects = $('.js-linked-header-select');
    ...
    function selectBoxChanged($selectBox) {
        ...
        if (selectedOptionId.indexOf('head-pleaseSelect') !== -1) {
    ...
    function getMatchingSelectObject(selectBoxId) {
        return _.where(linkedSelectsHeaderJSON, {'id': selectBoxId});
    }
